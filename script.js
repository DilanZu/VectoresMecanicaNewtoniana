document.addEventListener('DOMContentLoaded', () => {
    ...
    calculateBtn.addEventListener('click', () => {
        ...
        if (modeA === 'cartesianas') {
            ...
            if (isNaN(ax) || isNaN(ay) || isNaN(az)) {
                alert('Por favor, introduce valores numéricos para el Vector A.');
                return;
            }
        ...
        if (modeB === 'cartesianas') {
            const bx = parseFloat(bxInput.value);
            const by = parseFloat(byInput.value);
            const bz = parseFloat(bzInput.value);
            if (isNaN(bx) || isNaN(by) || isNaN(bz)) {
                alert('Por favor, introduce valores numéricos para el Vector B.');
                return;
            }
        ...
        ctx.fillStyle = 'green';
        ctx.fillText(`Proyección`, projX * scale, -projY * scale);
    ...
    calculateAccelBtn.addEventListener('click', () => {
        ...
        if (modeA === 'cartesianas') {
            const ax = parseFloat(accelXInput.value);
            const ay = parseFloat(accelYInput.value);
            const az = parseFloat(accelZInput.value);
            if (isNaN(ax) || isNaN(ay) || isNaN(az)) {
                alert('Por favor, introduce valores numéricos para la Aceleración (A).');
                return;
            }
            vectorA = {x: ax, y: ay, z: az};
        } else {
        ...
        if (modeV === 'cartesianas') {
            ...
            const vz = parseFloat(velZInput.value);
            if (isNaN(vx) || isNaN(vy) || isNaN(vz)) {
                alert('Por favor, introduce valores numéricos para la Velocidad (V).');
                return;
            }
